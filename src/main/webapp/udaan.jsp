...
<header class="header">
    <nav class="navbar">
      <div class="navbar-container container">
        <div>
          <h1 class="navbar-brand">Udaan Club</h1>
        </div>
        <ul class="menu-items">
    ...
    <div class="container">
      <div class="about-content">
        <div class="center-content">
          ...
          <p>
            A cultural club within a college campus serves as a vibrant hub for celebrating diversity, fostering inclusivity, and promoting cultural exchange. Through a myriad of events, activities, and initiatives, cultural clubs offer students a platform to explore, appreciate, and engage with various cultures, traditions, and perspectives. Whether through cultural festivals, language exchange sessions, or immersive experiences, these clubs create opportunities for students to connect with others who share their cultural background or interests, as well as to learn from those with different backgrounds. By facilitating meaningful dialogue, promoting cross-cultural understanding, and fostering a sense of belonging, cultural clubs play an indispensable role in enhancing the college experience and preparing students to thrive in an increasingly interconnected world.
          </p>
      ...
      <div class="portfolio-content container">
        <div class="proj-1">
          <div class="proj1-details">
            ...
            <h2>Dandiya Night</h2>
            <div>
                <img src="udaan rit.jpeg" alt="" height="200" width="300">
            </div>
        ...
        <div class="proj-2">
          <div class="proj2-details">
            ...
            <div>
                <img src="rit.jpeg" alt="" height="200" width="300">
            </div>
           <br><br><br>
          </div>
