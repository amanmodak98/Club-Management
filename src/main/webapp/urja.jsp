...
<header class="header">
    <nav class="navbar">
      <div class="navbar-container container">
        <div>
          <h1 class="navbar-brand">Urja Club</h1>
        </div>
        <ul class="menu-items">
    ...
    <div class="container">
      <div class="about-content">
        <div class="center-content">
          ...
          <p>
            A sports club is a vibrant community hub where individuals come together to engage in various physical activities and competitions. These clubs provide a platform for people of all ages and backgrounds to participate in sports, fostering a sense of camaraderie and teamwork. Whether it's football, basketball, tennis, or swimming, sports clubs offer a wide range of disciplines to cater to diverse interests. Beyond just physical fitness, these clubs promote mental well-being, discipline, and healthy competition. They serve as places where athletes can hone their skills under the guidance of experienced coaches and mentors. Moreover, sports clubs often host events, tournaments, and social gatherings, strengthening bonds among members and contributing to the overall vitality of the community. Through participation in a sports club, individuals not only improve their athletic abilities but also cultivate lifelong friendships and invaluable life skills.
          <div class="work-arrow">
            <p>
              <a href="#my-works">Check out the events <i class="fas fa-arrow-down"></i></a>
            </p>
          </div>
        </div>
      ...
      <div class="portfolio-content container">
        <div class="proj-1">
          <div class="proj1-details">
            ...
            <h2>Sports-tech</h2>
            <div>
                <img src="sports.jpg" alt="" height="200" width="300">
            </div>
