...
<header class="header">
    <nav class="navbar">
      <div class="navbar-container container">
        <div>
          <h1 class="navbar-brand">Utthaan Club</h1>
        </div>
        <ul class="menu-items">
    ...
    <div class="container">
      <div class="about-content">
        <div class="center-content">
          ...
          <p>
            A technical club serves as a hub for enthusiasts to explore, learn, and innovate within various fields of technology. Through workshops, seminars, and hands-on projects, members delve into coding, robotics, artificial intelligence, and more. These clubs foster a collaborative environment where individuals can share knowledge, exchange ideas, and tackle real-world challenges. Additionally, they often organize competitions and events, providing opportunities for members to showcase their skills and creativity. Overall, a technical club not only enhances technical proficiency but also cultivates critical thinking, problem-solving, and teamwork abilities essential for success in the ever-evolving tech landscape.
          </p>
      ...
      <div class="portfolio-content container">
        <div class="proj-1">
          <div class="proj1-details">
            ...
            <div>
                <img src="sci day.jpeg" alt="" height="200" width="300">
            </div>
        ...
        <div class="proj-2">
          <div class="proj2-details">
            <h2>Technomax</h2>
            <div>
                <img src="tecno.jpeg" alt="" height="200" width="300">
            </div>
           <br><br><br>
          </div>
